...
const page = () => {
  ...
  const handleOtpKeyDown = (
    ...
    if (e.key === "Backspace") {
      // If the current field is empty and the user is not in the first input, move focus to the previous field
      ...
      <div className="md:w-[480px] p-8 bg-white shadow rounded-lg">
        ...
        {activeStep === 3 && (
          <div className="text-center">
            ...
            <button
              className="w-full m-auto flex items-center justify-center gap-3 text-lg  bg-[#334155] text-white py-2 rounded-lg mt-6 cursor-pointer"
